...
st.set_page_config(page_title = "CarPricePrediction",page_icon = ":car:", layout = 'centered', initial_sidebar_state = 'auto')
...
import plots
import predicts
pages_dict = {"Home" :home,"View Data": data,"Visualise Data": plots, "Predict": predicts}
st.sidebar.title("Navigation")
user_choice = st.sidebar.radio("Goto",("Home","View Data","Visualise Data","Predict"))
